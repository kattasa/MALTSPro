...
def doubly_robust_parallel(dataset_iteration):
    ...
    treated_file_name = open(dataset_directory + '/dataset_' + str(seed) + '/doubly_robust_rf.pkl', 'wb')
    ...
    ITE_doubly_robust_df.to_csv(dataset_directory + '/dataset_' + str(seed) + '/dr_rf_ITE.csv')
