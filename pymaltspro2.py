...
def wasserstein2_barycenter(sample_array_1_through_n, weights, n_samples_min, array_quantiles = True):
    '''
    description
    -----------
    ...
    if array_quantiles == False:
        ...
        # if the given array is already empirical quantile function, don't use this
        qtls_1_through_n = sample_array_1_through_n
    
    # compute quantile of barycenter as average of quantiles
...
def linbo_ITE(y_obs, y_cf, observed_treatment, reference_distribution, y_obs_qtl_id = False, y_cf_qtl_id = False):
		'''
		description
		-----------
