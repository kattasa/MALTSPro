#!/usr/bin/env bash
#SBATCH --job-name=sin_dgp # Job name
...
srun -u python3 ./sin_sim_dgp_generate_data.py
# srun -u python3 ./maltspro_continuous_features_experiments.py
# srun -u python3 ./psmatch_continuous_features_experiments.py
# srun -u python3 ./wass_tree_continuous_features_experiments.py -f ./experiments/sin_sim_dgp
